...
const clearSource = import.meta.env.VITE_CLEAR_SOURCE === "true";
const detectImageSize = import.meta.env.VITE_DETECT_IMAGE_SIZE === "true";
const usedAssetsOnly = import.meta.env.VITE_USED_ASSETS_ONLY === "true";
const duplicateFolders = import.meta.env.VITE_DUPLICATE_FOLDERS === "true";
